 ...
 */
@Stateless
@Path("entidades.coupon")
public class CouponFacadeREST extends AbstractFacade<Coupon> {

    @PersistenceContext(unitName = "WebApplication3piPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Coupon entity) {
        super.edit(entity);
    }
    ...
    public Coupon find(@PathParam("id") Integer id) {
